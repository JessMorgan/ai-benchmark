...
from benchmark.configuration import get_model_plugins_blacklist, get_target_plugins_blacklist
...
class TestPerModelPluginBlacklist(unittest.TestCase):
    def test_string_model_returns_empty_blacklist(self):
        ...
        self.assertEqual(get_target_plugins_blacklist(models, "model-a"), [])
    ...
    def test_dict_model_with_blacklist_returns_list(self):
        ...
        self.assertEqual(get_target_plugins_blacklist(models, "model-a"), ["rate-limiter"])
    ...
    def test_dict_model_with_multiple_blacklisted_plugins(self):
        ...
        self.assertEqual(get_target_plugins_blacklist(models, "model-a"), ["rate-limiter", "moe-dense"])

    def test_nonexistent_model_returns_empty_blacklist(self):
        models = {"model-a": {"source": "source-1", "plugins_blacklist": ["rate-limiter"]}}
        self.assertEqual(get_target_plugins_blacklist(models, "nonexistent"), [])
