...
from benchmark.tui import _BenchmarkTUIApp as _TUIBenchmarkApp
from benchmark.tui import _FrameRow as _TUIFrameRow
...
# Textual app implementation lives in benchmark.tui; these aliases preserve
# the historical benchmark.cli import surface while callers migrate.

class _FrameRow(_TUIFrameRow):
    pass

class _BenchmarkTUIApp(_TUIBenchmarkApp):
...
_tui._changed_cell_spans = _changed_cell_spans
_tui._FRAME_STYLE_MAP = _FRAME_STYLE_MAP
_tui._TUI_REFRESH_SECONDS = _TUI_REFRESH_SECONDS
_tui._build_frame_lines = _build_frame_lines
_tui._unique_source_abbrevs = _unique_source_abbrevs
_tui._fallback_tui_loop = _fallback_tui_loop


def _textual_tui_enabled():
    return _tui._textual_tui_enabled()
            ...
            if judge_models:
                ...
                for plugin in active_plugins:
                    ...
                    sqlite_store.register_contract(
                        ...
                        instructions_version=contract.instructions_version,
